...
let egs: Map<string, number>  = new Map([
    ['MU', 8], ['KL', 8], ['IN', 8], ['CH', 8],
    ['FF', 8], ['GE', 8], ['KO', 8], ['KK', 8]
    ]);
let koerTal: Map<string, number>  = new Map([
...
let handTal: Map<string, number>  = new Map([
 ...
 * Output: None
*/
function setValue(type:string, talent:string, num:number): void {
    switch(type){
        case 'Körper':
